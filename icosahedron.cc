...
// Draw the Icosahedron in 3–D space and display it from a viewing point.
void Test1()
{
}
// Add a 10 hertz (update every 100ms) and animation rotation about both the x and y axes.
void Test2()
{
}
